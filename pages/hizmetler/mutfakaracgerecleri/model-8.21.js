...
const HizmetDetay = () => {
  return (
    <>
      <Head>
        <title>Model-8.21</title>
        <meta property="og:title" content="Model-8.21" />
        <meta
          name="description"
          content="Model-8.21 hakkında detaylı bilgi edinin. Mutfak Eşya ve Ev Gereçleri yer alan ürünümüz."
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://mirzakalip.com/hizmetler/medikal-kaliplar/model-8.21"
        />
        <meta
          property="og:image"
          content="/mutfakaracgerecleri/Model-8.21.jpg"
        />{" "}
      </Head>

      <Layout>
        <BreadCrumb>
          <Title fontSize="50px">Model-8.21</Title>
        </BreadCrumb>
        <Section>
          <Container>
            <Grid
