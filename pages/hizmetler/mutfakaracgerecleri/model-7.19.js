...
const HizmetDetay = () => {
  return (
    <>
      <Head>
        <title>Model-7.19</title>
        <meta property="og:title" content="Model-7.19" />
        <meta
          name="description"
          content="Model-7.19 hakkında detaylı bilgi edinin. Mutfak Eşya ve Ev Gereçleri yer alan ürünümüz."
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://mirzakalip.com/hizmetler/medikal-kaliplar/model-7.19"
        />
        <meta
          property="og:image"
          content="/mutfakaracgerecleri/Model-7.19.jpg"
        />
      </Head>
      <Layout>
        <BreadCrumb>
          <Title fontSize="50px">Model-7.19</Title>
        </BreadCrumb>
        <Section>
          <Container>
            <Grid
