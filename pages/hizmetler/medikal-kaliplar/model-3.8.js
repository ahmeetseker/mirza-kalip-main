...
const HizmetDetay = () => {
  return (
    <>
      <Head>
        <title>Model-3.8</title>
        <meta property="og:title" content="Model-3.8" />
        <meta
          name="description"
          content="Model-3.8 hakkında detaylı bilgi edinin. Medikal Kalıplar kategorisinde yer alan ürünümüz."
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://mirzakalip.com/hizmetler/medikal-kaliplar/model-3.8"
        />
        <meta property="og:image" content="/medikalkaliplar/Model-3.8.jpg" />
      </Head>
      <Layout>
        <BreadCrumb>
          <Title fontSize="50px">Model-3.8</Title>
        </BreadCrumb>
        <Section>
          <Container>
            <Grid
