...
const HizmetDetay = () => {
  return (
    <>
      <Head>
        <title>Model-6.18</title>
        <meta property="og:title" content="Model-6.18" />
        <meta
          name="description"
          content="Model-6.18 hakkında detaylı bilgi edinin. Medikal Kalıplar kategorisinde yer alan ürünümüz."
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://mirzakalip.com/hizmetler/medikal-kaliplar/model-6.18"
        />
        <meta property="og:image" content="/medikalkaliplar/Model-6.18.jpg" />
      </Head>
      <Layout>
        <BreadCrumb>
          <Title fontSize="50px">Model-6.18</Title>
        </BreadCrumb>
        <Section>
          <Container>
            <Grid
