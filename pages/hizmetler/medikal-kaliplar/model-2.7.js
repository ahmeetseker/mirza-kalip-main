...
const HizmetDetay = () => {
  return (
    <>
      <Head>
        <title>Model-2.7</title>
        <meta property="og:title" content="Model-2.7" />
        <meta
          name="description"
          content="Model-2.7 hakkında detaylı bilgi edinin. Medikal Kalıplar kategorisinde yer alan ürünümüz."
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://mirzakalip.com/hizmetler/medikal-kaliplar/model-2.7"
        />
        <meta property="og:image" content="/medikalkaliplar/Model-2.7.jpg" />
      </Head>
      <Layout>
        <BreadCrumb>
          <Title fontSize="50px">Model-2.7</Title>
        </BreadCrumb>
        <Section>
          <Container>
            <Grid
