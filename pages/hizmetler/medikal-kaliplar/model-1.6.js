...
const ServiceDetailPage = () => {
  return (
    <>
      <Head>
        <title>Model-1.6</title>
        <meta property="og:title" content="Model-1.6" />
        <meta
          name="description"
          content="Model-1.6 hakkında detaylı bilgi edinin. Medikal Kalıplar kategorisinde yer alan ürünümüz."
        />
        <meta
          property="og:description"
          content="Model-1.6 hakkında detaylı bilgi edinin. Medikal Kalıplar kategorisinde yer alan ürünümüz."
        />
        <meta property="og:url" content="https://mirzakalip.com/hizmetler/medikal-kaliplar/model-1.6" />
        <meta property="og:image" content="/medikalkaliplar/Model-1.6.jpg" />
      </Head>
      <Layout>
        <BreadCrumb>
          <Title fontSize="50px">Model-1.6</Title>
        </BreadCrumb>
        <Section>
          <Container>
            <Grid
        ...
        <Section bg="#f6f6f6">
          ...
          <Container p="0px !important;">
            ...
            >
              ...
              <News>
                <News.Image src="/medikalkaliplar/Model-5.10.jpg" />
                <News.Date>Medikal Kalıplar</News.Date>
                <News.Content>
                  <Title as="h4" fontSize="18px">
                    Model-5.10
                  ...
                  <News.Link href="/hizmetler/medikal-kaliplar/model-5.10" />
                </News.Content>
              </News>
              <News>
